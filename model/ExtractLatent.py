...
DATASET_SAMPLES = Path("../data/datasets/intraday_1h_ae/samples.parquet")
CKPT_PATH = Path("../models/ae_1h/best.pt")
OUT_PATH = Path("../data/datasets/intraday_1h_ae/latent32.parquet")
